...
#   pacman -S mingw-w64-x86_64-toolchain --noconfirm
  ...
  ~/dotfile/app-fast/app-fast install -y man vim micro git tig zsh fish tmux curl aria2 file tar wget bash-completion htop openssh mosh grep sed gawk ffmpeg p7zip
