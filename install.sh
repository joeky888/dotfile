...
#   install ~/dotfile/app-fast/app-fast /usr/local/bin/app-fast
  ~/dotfile/app-fast/app-fast install bash zsh vim coreutils grep findutils file-formula gnu-sed make automake autoconf wget opencc ffmpeg tig tmux p7zip htop watch atool nmap
