...
END
  ...
  rm -rf $Home/dotfile/
  git clone --depth=1 git://github.com/j16180339887/dotfile.git $Home/dotfile
  ...
  git clone --depth 1 git://github.com/garabik/grc.git $Home/grc
...
END
  ...
  $SUDO pkg update
  echo y | $SUDO pkg install tmux zsh git vim nano curl python3 ubuntu-font
