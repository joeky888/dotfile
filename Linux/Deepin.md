...
deb [by-hash=force] http://ftp.sjtu.edu.cn/deepin/ unstable main contrib non-free universe
deb [by-hash=force] http://mirror.bit.edu.cn/deepin/ unstable main contrib non-free universe
...
=====
* Deepin
  * $ sudo apt-fast install sogoupinyin adb fastboot opera-developer opera-stable noto-fonts ttf-wps-fonts vscode teamviewer skypeforlinux qpdfview evince nomacs vlc obs-studio earlyoom console-setup deepin-graphics-driver-manager deepin-remote-assistance deepin-repair-tools deepin-system-monitor deepin.com.baidu.pan opencc vim-gtk3 file-roller software-properties-gtk baobab gnome-system-monitor gnome-disk-utility -y && sudo apt purge vim foxitreader spotify-client skype -y
