...
* Manjaro
  ...
  * $ sudo powerpill -S --noconfirm --needed gvim fcitx fcitx-rime fcitx-im fcitx-configtool fcitx-configtool android-tools opera nomacs qpdf file-roller vlc obs-studio evince gnome-disk-utility baobab
