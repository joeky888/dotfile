...
* Or
* $ `sudo powerpill -Sy --noconfirm --needed wine-staging wine-mono wine_gecko cabextract zenity && winecfg`
...
* $ bash winetricks busybox cmd 7zip lucida ie8 msxml3 msxml4 msxml6 xmllite d3dx9 d3dx10 d3dxof d3drm quartz wininet xact xinput xna31 xna40
