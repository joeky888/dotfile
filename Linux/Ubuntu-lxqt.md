...
Install LXQT
=====
* $ sudo apt-fast install lxqt xorg openbox compton gnome-terminal chromium-codecs-ffmpeg-extra shutter vim-gtk3 network-manager network-manager-gnome file-roller software-properties-kde baobab gnome-system-monitor gnome-disk-utility -y && sudo apt-fast purge connman -y
