...
Install LXQT
=====
* $ sudo apt-fast install lxqt xorg openbox compton nautilus gnome-terminal chromium-codecs-ffmpeg-extra vim-gtk3 network-manager file-roller software-properties-kde baobab gnome-system-monitor gnome-disk-utility -y
* Or using ppa
