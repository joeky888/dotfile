...
choco install 7zip git poshgit openssl.light fluent-terminal vscodium greenshot wps-office-free obs-studio nomacs fontforge sumatrapdf.commandline xnviewmp krita -y --pre
