...
choco install 7zip git poshgit openssl.light skype vscodium greenshot wps-office-free obs-studio nomacs fontforge sumatrapdf.commandline xnviewmp krita brave -y --pre
