...
if has("gui_running")
  ...
  call CreateShortcut("C-c", "0v$<Right>\"+y", "in")
  call CreateShortcut("C-c", "\"+y", "v")
  cnoremap <C-c> <C-y>

  " Ctrl X is cutting line if there is no word selected
  call CreateShortcut("C-x", "0v$<Right>\"+x<ESC>ddi<C-g>u", "i", "noTrailingIInInsert")
  call CreateShortcut("C-x", "0v$<Right>\"+x<ESC>dd", "n")
