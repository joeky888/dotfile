...
export PLAYER_ARGUMENTS="--cache=yes --cache-dir=/tmp --cache-on-disk=yes --ytdl-raw-options=no-check-certificate=,yes-playlist=,ignore-errors=,write-auto-subs=,write-subs=,sub-langs='(en|zh).*'"
