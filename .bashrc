...
if [[ $(command -v aria2c) ]]; then
  alias youtube-dl='youtube-dl -o "%(title)s.%(ext)s" --retries 20 --write-sub --sub-lang zh-TW,zh-HK,zh-Hant,zh-CN,zh-Hans,en,enUS,English --ignore-errors --external-downloader aria2c --external-downloader-args $DOWNLOADER_ARGUMENTS'
else
  alias youtube-dl='youtube-dl -o "%(title)s.%(ext)s" --retries 20 --write-sub --sub-lang zh-TW,zh-HK,zh-Hant,zh-CN,zh-Hans,en,enUS,English --ignore-errors'
fi
