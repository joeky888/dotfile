...
alias youtube-dl='youtube-dl --write-sub --ignore-errors'
...
alias wget='wget -c -e robots=off'
alias aria2c='aria2c -c --max-connection-per-server=16 --split=16 --min-split-size=1M'
