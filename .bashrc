...
alias streamlink-mpv-1080="streamlink --loglevel debug --verbose-player --player 'mpv' --player-arg '$PLAYER_ARGUMENTS' --stream-segment-threads 10 --title '{title}' --default-stream 1080p60"
