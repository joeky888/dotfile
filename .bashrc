...
if hash youtube-dl 2>/dev/null >/dev/null; then
  ...
  [ $(command -v curl) ] && alias curl='curl --retry 1 --connect-timeout 10 --max-time 10 --retry-delay 0 --retry-max-time 20 --user-agent "$(youtube-dl --dump-user-agent)" -LC - '
  ...
  [ $(command -v curl) ] && alias curl='curl --retry 1 --connect-timeout 10 --max-time 10 --retry-delay 0 --retry-max-time 20 -LC - '
...
alias streamlink-mpv-best="streamlink --verbose-player -p mpv --default-stream best"
...
alias mpv-1080='mpv --ytdl-format="bestvideo[height<=1080][fps<=30]+bestaudio/best" --cache=1048576' # 1GB youtube-dl cache
alias mpv-720='mpv --ytdl-format="bestvideo[height<=720][fps<=30]+bestaudio/best" --cache=600000'
alias mpv-480='mpv --ytdl-format="bestvideo[height<=480][fps<=30]+bestaudio/best" --cache=600000'
