...
alias upgradeYoutubedl='pip install --upgrade --force-reinstall https://github.com/ytdl-org/youtube-dl/archive/master.zip'
alias upgradeYou-get='pip install --upgrade --force-reinstall https://github.com/soimort/you-get/archive/develop.zip'
alias upgradeYkdl='pip install --upgrade --force-reinstall https://github.com/zhangn1985/ykdl/archive/master.zip'
alias upgradeStreamlink='pip install --upgrade --force-reinstall https://github.com/streamlink/streamlink/archive/master.zip'
alias upgradeAnnie='GO111MODULE=on go get -insecure -v github.com/iawia002/annie'
alias upgradeMycli='pip install --upgrade --force-reinstall https://github.com/dbcli/mycli/archive/master.zip'
alias upgradeLitecli='pip install --upgrade --force-reinstall https://github.com/dbcli/litecli/archive/master.zip'
...
alias mpv-loop="mpv --loop --ytdl-format='bestvideo[height<=720][fps<=30][ext=mp4]+bestaudio/best' $PLAYER_ARGUMENTS"
