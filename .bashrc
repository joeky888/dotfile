...
export MPV_ARGUMENTS='--cache=1048576 --cache-secs=1800 --ytdl-raw-options=no-check-certificate='
...
alias mpv-1080="mpv --ytdl-format='bestvideo[height<=1080][fps<=30]+bestaudio/best' $MPV_ARGUMENTS"
alias mpv-720="mpv --ytdl-format='bestvideo[height<=720][fps<=30]+bestaudio/best' $MPV_ARGUMENTS"
alias mpv-480="mpv --ytdl-format='bestvideo[height<=480][fps<=30]+bestaudio/best' $MPV_ARGUMENTS"
alias mpv-480="mpv --mute=yes --ytdl-format='bestvideo[height<=720][fps<=30]+bestaudio/best' $MPV_ARGUMENTS"
alias mpv-ass2srt="mpv --sub-ass-override=strip $MPV_ARGUMENTS"
alias mpv-3Dto2D="mpv --vf=stereo3d=out=ml $MPV_ARGUMENTS"
