...
export PLAYER_ARGUMENTS="--cache=yes --cache-secs=36000 --cache-dir=/tmp --cache-on-disk=yes --ytdl-raw-options=no-check-certificate=,yes-playlist=,ignore-errors="
...
alias upgradeBashrc='curl https://raw.githubusercontent.com/joeky888/dotfile/master/.bashrc -o ~/.bashrc'
...
alias mpv-gpu-intel="mpv --hwdec=vaapi" # echo "hwdec=vaapi" >> /etc/mpv/mpv.conf
