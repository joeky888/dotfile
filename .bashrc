...
alias mpv-fast-4k="mpv --ytdl-format='bestvideo[height<=2160][vcodec!^=av01][protocol^=m3u]+bestaudio/best' --title='\${media-title}-\${metadata/date}' $PLAYER_ARGUMENTS"
alias mpv-fast-2k="mpv --ytdl-format='bestvideo[height<=1440][vcodec!^=av01][protocol^=m3u]+bestaudio/best' --title='\${media-title}-\${metadata/date}' $PLAYER_ARGUMENTS"
alias mpv-fast-1080="mpv --ytdl-format='bestvideo[height<=1080][vcodec!^=av01][protocol^=m3u]+bestaudio/best' --title='\${media-title}-\${metadata/date}' $PLAYER_ARGUMENTS"
