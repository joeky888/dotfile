...
alias yt-dlp-240="yt-dlp -f 'bestvideo[height<=240][fps<=30][vcodec^=vp9]+bestaudio/best'"
alias yt-dlp-360="yt-dlp -f 'bestvideo[height<=360][fps<=30][vcodec^=vp9]+bestaudio/best'"
alias yt-dlp-480="yt-dlp -f 'bestvideo[height<=480][fps<=30][vcodec^=vp9]+bestaudio/best'"
alias yt-dlp-720="yt-dlp -f 'bestvideo[height<=720][fps<=30][vcodec^=vp9]+bestaudio/best'"
alias yt-dlp-1080="yt-dlp -f 'bestvideo[height<=1080][vcodec^=vp9]+bestaudio/best'"
...
alias streamlink-download="streamlink --loglevel debug --stream-segment-threads 10 --title '{title}' --default-stream best -o '{title}.mp4'"
alias mpv-1080="mpv --ytdl-format='bestvideo[height<=1080][vcodec^=vp9]+bestaudio/best' $PLAYER_ARGUMENTS"
alias mpv-720="mpv --ytdl-format='bestvideo[height<=720][fps<=30][vcodec^=vp9]+bestaudio/best' $PLAYER_ARGUMENTS"
alias mpv-480="mpv --ytdl-format='bestvideo[height<=480][fps<=30][vcodec^=vp9]+bestaudio/best' $PLAYER_ARGUMENTS"
alias mpv-mute="mpv --mute=yes --ytdl-format='bestvideo[height<=720][fps<=30][vcodec^=vp9]+bestaudio/best' $PLAYER_ARGUMENTS"
alias mpv-loop="mpv --loop --ytdl-format='bestvideo[height<=720][fps<=30][vcodec^=vp9]+bestaudio/best' $PLAYER_ARGUMENTS"
...
alias mpv-1080-proxy="mpv --stream-lavf-o-append=http_proxy=proxy.uku.im:443 --ytdl-format='bestvideo[height<=1080][vcodec^=vp9]+bestaudio/best' $PLAYER_ARGUMENTS"
alias mpv-1080-ontop="mpv --ontop --ytdl-format='bestvideo[height<=1080][vcodec^=vp9]+bestaudio/best' $PLAYER_ARGUMENTS"
