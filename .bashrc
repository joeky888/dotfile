...
alias ssh-asus-azure='ssh joeky@zenboml-api.eastasia.cloudapp.azure.com'
alias ssh-asus-dev='ssh -p 50022 joeky@contextualintelligence-dev.southeastasia.cloudapp.azure.com'
