...
export PLAYER_ARGUMENTS="--cache=yes --cache-dir=/tmp --cache-on-disk=yes --script-opts=ytdl_hook-ytdl_path=youtube-dl --ytdl-raw-options=no-check-certificate=,yes-playlist=,ignore-errors=,write-auto-sub="
