...
alias youtube-dl='youtube-dl --write-sub --sub-lang zh-TW,zh-CN,en --write-annotations --ignore-errors --external-downloader aria2c --external-downloader-args $DOWNLOADER_ARGUMENTS'
