...
#     PROMPT="%B%F{red}%n%B%F{yellow}@%B%F{green}%M %{$reset_color%}\n➜ %B%F{blue}%~"${NEWLINE_NO_OMZ}"%{$reset_color%}$ "
  ...
  if [ -n "$POWERLEVEL9K_PATH" ]; then # powerlevel9k.zsh-theme is available
    ...
    export POWERLEVEL9K_DIR_DEFAULT_FOREGROUND='gray'
    export POWERLEVEL9K_DIR_HOME_BACKGROUND='039'
    export POWERLEVEL9K_DIR_HOME_FOREGROUND='gray'
    export POWERLEVEL9K_DIR_HOME_SUBFOLDER_BACKGROUND='039'
    export POWERLEVEL9K_DIR_HOME_SUBFOLDER_FOREGROUND='gray'
