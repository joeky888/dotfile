...
| 民俗傳說          | 倒塌，推翻 | 佔優勢的；主要的；突出的 | 雄偉建築；豪華大廈 | 主食；主要成分 |
| ----------------- | ---------- | ------------------------ | ------------------ | -------------- |
| folktale/folklore | topple     | predominant/principal    | edifice            | staple         |
...
| 木炭     | 發掘、挖掘、出土                    | 通風 n.     | 陶器(的)     | 迷宮           |
| -------- | ----------------------------------- | ----------- | ------------ | -------------- |
| Charcoal | (v.) Excavate/exhume/unearth/dug up | ventilation | adj. ceramic | labyrinth/maze |

| 雕刻/雕刻術                | (塗)亮光漆 n. vt.    | 基本圖案 | 古董    | 甕、罈 | 罐  |
| -------------------------- | -------------------- | -------- | ------- | ------ | --- |
| engraving/carving/inscribe | varnish/polish/glaze | motif    | antique | urn    | jar |
...
| ferry | freight            | freight bill | curb                    | pedestrian crossing | oar            |
| ----- | ------------------ | ------------ | ----------------------- | ------------------- | -------------- |
| 渡輪  | (海陸空)貨運、貨物 | (海陸空)運費 | 路邊;（人行道旁的）邊欄 | 行人穿越道          | 槳；划手；槳手 |

| parcel(s) | at the junction/on the bend | embargo |
| --------- | --------------------------- | ------- |
| 小包裹    | 在交叉道                    | 禁運    |
...
| 小派系        | 定罪；指控 | 被逮捕         | (證據不足的情況)被指控的犯人 |
| ------------- | ---------- | -------------- | ---------------------------- |
| petty faction | indictment | be apprehended | alleged culprit              |
