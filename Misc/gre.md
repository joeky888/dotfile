...
ceteris paribus 其他條件不變的情況下，比較 treatment group vs. control group
...
| 官僚主義      | 沙文主義   | 自由放任主義、不干涉主義 | 懷疑主義、懷疑論 | 純粹主義；正統主義 |
| ------------- | ---------- | ------------------------ | ---------------- | ------------------ |
| bureaucratism | chauvinism | laissez faire            | skepticism       | Purism             |

| (神)不可知論(的) | 實用主義、功利主義 | 武力外交主義/軍國主義(者) | 憤世嫉俗者/犬儒主義/憤世嫉俗、嘲笑主義 |
| ---------------- | ------------------ | ------------------------- | -------------------------------------- |
| agnostic(ism)    | utilitarianism     | jingoism/jingoist         | cynic/cynicism                         |

| 狂熱者                                   | 享樂縱慾主義 |
| ---------------------------------------- | ------------ |
| ideologue/lunatic fringe/partisan/zealot | sybarite     |

| (美英)廢奴主義/解放奴隸             | 女性投票權       | 緘默權           |
| ----------------------------------- | ---------------- | ---------------- |
...
## Four temperaments 古希臘體液學說的四種氣質

| Sanguine       | Choleric   | Melancholic | Phlegmatic |
| -------------- | ---------- | ----------- | ---------- |
| 春             | 夏         | 秋          | 冬         |
| 血色好、紅潤的 | 黃膽汁多的 | 黑膽汁多的  | 多痰的     |
| 樂觀的         | 暴躁的     | 憂鬱的      | 冷淡的     |
...
| dispassionate | imperturbable | sangfroid | impersonality | lukewarm | stolid |
| ------------- | ------------- | --------- | ------------- | -------- | ------ |
| 公正的 冷靜的 | 冷靜的        | 冷靜的    | 冷靜客觀      | 冷淡的   | 冷淡的 |
...
| bland  | insipid | plodding   | vacuous    | vapid  | jejune |
| ------ | ------- | ---------- | ---------- | ------ | ------ |
| 乏味的 | 乏味的  | 單調乏味的 | 空洞無聊的 | 乏味的 | 乏味的 |
...
| interminable | tedious    | tepid  | weary  |
| ------------ | ---------- | ------ | ------ |
| 冗長的       | 乏味冗長的 | 冷淡的 | 無聊的 |
...
| repress | muzzle | stem | bridle | rein in | harness | prescribed | stymied |
| ------- | ------ | ---- | ------ | ------- | ------- | ---------- | ------- |
| 壓抑    | 限制   | 限制 | 限制   | 阻礙    | 控制    | 規定的     | 受阻    |

| refrain from | manacle | squelch | avert | immure |
| ------------ | ------- | ------- | ----- | ------ |
| 抑制         | 約束    | 遏制    | 防止  | 限制   |

## 阻礙、妨礙 (比完全禁止稍弱的詞，但比限制、抑制稍強的詞)

| hinder | retard | impede | inhibit | obstruct | thwart | encumber |
| ------ | ------ | ------ | ------- | -------- | ------ | -------- |
| 阻礙   | 妨礙   | 阻止   | 阻止    | 阻礙     | 阻撓   | 阻礙     |
...
| forerunner   | precursor | herald | foretell | harbinger  | augur | omen | portend |
| ------------ | --------- | ------ | -------- | ---------- | ----- | ---- | ------- |
...
| recant     | abrogate | rescind | retract    |
| ---------- | -------- | ------- | ---------- |
| 取消、撤回 | 廢除     | 取消    | 取消、撤回 |

## 虛假、空話、偽造

| vanity | superficial | apocryphal | cant     | disingenuous | factitious     |
| ------ | ----------- | ---------- | -------- | ------------ | -------------- |
| 虛榮   | 膚淺        | 虛構       | 虛假空話 | 不真誠       | 虛假的、人工的 |

| hypocrisy | mendacious | specious       | veneer | feeble             | ideological      |
| --------- | ---------- | -------------- | ------ | ------------------ | ---------------- |
| 偽善      | 虛偽、說謊 | 華而不實、虛假 | 虛飾   | 虛弱；空話不負責的 | 意識形態、空談的 |

| inanity      | palaver      | pedant         | bogus  | counterfeit | fabricate  |
| ------------ | ------------ | -------------- | ------ | ----------- | ---------- |
| 空談；愚蠢的 | 空談；拍馬的 | 賣弄的；空談的 | 偽造的 | 偽造的      | 偽造、杜撰 |

| sanctimonious | spurious | feigned | ersatz     | phony | charlatan | artificial     |
| ------------- | -------- | ------- | ---------- | ----- | --------- | -------------- |
| 偽聖的        | 假的     | 偽造的  | 人造替代品 | 偽造  | 騙子      | 人造的；虛假的 |

| fallacious | chicanery  | prevaricate    | sham | simulacrum | pastiche | mannered |
| ---------- | ---------- | -------------- | ---- | ---------- | -------- | -------- |
| 錯誤的     | 欺騙、詭計 | 支吾其詞；說謊 | 騙局 | 幻影；仿品 | 模仿作品 | 不自然的 |
...
| abscond           | v.           | 潛逃、逃亡                                              | [æbˋskɑnd] rescinded廢止、取消                                     |
...
| burnish           | vi.vt.       | 磨光 擦亮                                               | tarnish玷污、損毀                                                  |
...
| cavalier          | n.adj.       | n.騎兵 adj.漫不經心的；傲慢的                           | [͵kævəˋlɪr] chivalrous騎士風度翩翩的                               |
| cede              | vt.          | 割讓、放棄                                              | [sid]                                                              |
...
| chivalrous        | adj.         | 有騎士風度的 彬彬有禮的                                 | [ˋʃɪv!rəs] cavalier馬虎傲慢的                                      |
...
| condone           | vt.          | 縱容；寬恕、容忍；赦免                                  | [kənˋdon]                                                          |
...
| covet             | vt.vi.       | 垂涎；貪圖；覬覦(他人之物)                              | [ˋkʌvɪt] caveat使用前注意                                          |
| cow               | vt.          | 恐嚇，威脅                                              | n.母牛                                                             |
...
| detract           | vi.vt.       | 貶低；減損，降低                                        | [dɪˋtrækt] detractors批評者                                        |
...
| gulf              | n.           | （意見等的）巨大分歧，鴻溝；(地面)裂口、深淵            | [gʌlf]                                                             |
...
| ineffable         | adj.         | 難以形容的；難以言表的；無法形容的                      | [ɪnˋɛfəb!] effable可表達的                                         |
...
| intertwine        | vi.          | 糾纏                                                    | [͵ɪntɚˋtwaɪn]                                                      |
| entwine           | vi.vt.       | 糾纏                                                    | [͵ɪntɚˋtwaɪn]                                                      |
| interwoven        | n.           | 相互交織                                                | [ˋɪntɚˋwovən]                                                      |
...
| lascivious        | adj.         | 淫蕩的；好色的；猥褻的                                  | [ləˋsɪvɪəs] 樂色的                                                 |
...
| officious         | adj.         | 愛管閒事的；過分殷勤的                                  | [əˋfɪʃəs] 喔廢話很多                                               |
...
| requiem           | n.           | 安魂曲；輓歌                                            | [ˋrikwɪəm]                                                         |
| rescind           | vt.          | 廢止；取消；撤回                                        | [rɪˋsɪnd] abscond逃亡                                              |
...
| scaremonger       | n.           | 危言聳聽者，散播恐怖謠言者；擾亂社會民心的人            | [ˋskɛr͵mʌŋgɚ] = alarmist                                           |
...
| specious          | adj.         | 華而不實的；虛假的                                      | [ˋspiʃəs]                                                          |
...
| stigmatization    | n.           | 恥辱；污名                                              | [ˋstɪgmə]                                                          |
...
| turpitude         | n.           | 奸惡；卑鄙；墮落                                        | [ˋtɝpə͵tjud] 特卑鄙                                                |
