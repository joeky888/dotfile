...
* $ choco install 7zip aria2 miniconda miniconda3 ffmpeg youtube-dl greenshot fontforge sumatrapdf.commandline xnviewmp inkscape cmake.portable git.portable vim-tux.portable adb -y --pre
