...
* $ choco install 7zip vim-tux.portable git.portable aria2 miniconda miniconda3 ffmpeg youtube-dl greenshot obs-studio vlc virtualbox fontforge sumatrapdf.commandline xnviewmp inkscape cmake.portable adb nodejs phantomjs -y --pre
