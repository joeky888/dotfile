...
* $ choco install aria2 miniconda miniconda3 ffmpeg youtube-dl greenshot sumatrapdf.commandline xnviewmp inkscape 7zip cmake.portable git.portable vim-tux.portable adb -y --pre
