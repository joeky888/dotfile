...
BaiduPCS-Go config set -appid=310646 # Or 309847 or 266719
...
* Chocolatey
    ...
    * $ choco install 7zip git poshgit vscode greenshot wps-office-free obs-studio nomacs vlc virtualbox fontforge sumatrapdf.commandline xnviewmp hyper gimp inkscape -y --pre
