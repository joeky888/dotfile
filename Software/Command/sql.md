...
```sh
# stdout
docker run --rm postgres:18.1-alpine pg_dump -c -C --dbname 'postgresql://username:password@127.0.0.1:5432/mydatabase' | psql --dbname 'postgresql://username:password@127.0.0.1:5432/newdatabase'
