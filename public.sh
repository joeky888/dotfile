...
perl -C -Mutf8 -ni -e 'print if !/template/' ~/dotfile/.gitconfig > ~/dotfile/.gitconfig
perl -C -Mutf8 -ni -e 'print if !/name/'     ~/dotfile/.gitconfig > ~/dotfile/.gitconfig
perl -C -Mutf8 -ni -e 'print if !/email/'    ~/dotfile/.gitconfig > ~/dotfile/.gitconfig
...
perl -C -Mutf8 -ni -e 'print if !/pageup/i'    ~/.vimrc
perl -C -Mutf8 -ni -e 'print if !/pagedown/i'  ~/.vimrc
