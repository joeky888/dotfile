...
function vlc-termux-streamlink-best-httpstream
  ...
  streamlink $STREAMLINK_ARGUMENTS --player 'am' --player-external-http --player-external-http-port 34567 --player-arg 'start --user 0 -a android.intent.action.VIEW -n org.videolan.vlc/.StartActivity -d vlc://{playerinput}' --default-stream best $argv[1] &
  sleep 10s
