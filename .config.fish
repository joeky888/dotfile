...
alias mpv-termux-streamlink-best="streamlink $STREAMLINK_ARGUMENTS --player 'am start -a android.intent.action.VIEW -n is.xyz.mpv/.MPVActivity -d' --player-continuous-http --player-args 'vlc://{playerinput}'  --default-stream best"
...
alias vlc-termux-streamlink-best="streamlink $STREAMLINK_ARGUMENTS --player 'bash -c \"am start -a android.intent.action.VIEW -n org.videolan.vlc/org.videolan.vlc.gui.video.VideoPlayerActivity -d\"' --player-continuous-http --player-args 'vlc://{playerinput}' --default-stream best"
