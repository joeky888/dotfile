...
alias vlc-termux-streamlink-best="streamlink $STREAMLINK_ARGUMENTS --player 'am start -a android.intent.action.VIEW -n org.videolan.vlc/org.videolan.vlc.gui.video.VideoPlayerActivity' --player-continuous-http --player-args 'vlc://{playerinput}' --default-stream best"
